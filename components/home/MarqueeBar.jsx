export default function MarqueeBar() {
  return (
    <div className="bg-[#FDE883] py-2.5 overflow-hidden whitespace-nowrap border-y border-yellow-200 flex">
      <div className="animate-marquee whitespace-nowrap flex text-xs font-medium tracking-wide text-gray-800 w-max">
        {/* First Set */}
